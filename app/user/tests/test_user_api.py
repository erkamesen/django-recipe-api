...
class PublicUserAPITests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test if password shorter than 5 throw error"""
        payload = {
            "email": "test@example.com",
            "password": "123",
            "name": "Test Name"
    ...
    def test_create_token_bad_credentials(self):
        """Test throw an error if credentials invalid"""
        user_details = {
            "name": "Test Name",
            "email": "test@example.com",
            "password": "validpass"
    ...
    def test_create_token_blank_password(self):
        """Test throw an error if password field empty"""
        payload = {
            "email": "test@example.com",
            "password": ""
        }
...
class PrivateUserAPITest(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test /me endpoint and post method"""
    ...
    def test_update_user_profile(self):
        """Test profile if user authenticated"""
